...
ap.io.nudge = 0; % Nudge the start of the pulse due to measurement jitter
ap.io.fit_dur = 50;
...
ap.rv.frange = 1000;        % Range of frequencies to compute frequency dependent gain
...
ap.rv.fdg.xlim = [1 20];    % ylim for plotting results of frequency depedent gain
ap.rv.fdg.gylim = [0 1.5];  % YLIM FOR gain plotting
ap.rv.fdg.pylim = [-1 1];   % ylim for phase plotting
...
ap.pwc.alpha = 0.75;            % Alpha value for corrections
ap.pwc.Iterations = 1000;       % Number of iterations for corrections
